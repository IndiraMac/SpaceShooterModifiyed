...
public class spaceShipMovement : MonoBehaviour
{
    ...
    public GameObject developerName;
    public GameObject developerLogo;
    ...
    void Start()
    {
        ...
        developerName.SetActive(true);
        developerLogo.SetActive(true);
        gameMusic.Play();
    }
    ...
    public void StartGame(){
        ...
        LogoEnd.SetActive(false);
        developerLogo.SetActive(false);
        developerName.SetActive(false);
    }
